# CDKTN Go bindings for hashicorp/vault provider version 5.10.1

This repo builds and publishes the [Terraform vault provider](https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs) bindings for [CDK Terrain](https://cdktn.io).
...
* [Terraform vault provider](https://registry.terraform.io/providers/hashicorp/vault/5.10.1)
