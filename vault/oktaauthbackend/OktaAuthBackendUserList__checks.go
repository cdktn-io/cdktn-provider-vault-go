...
func (j *jsiiProxy_OktaAuthBackendUserList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*OktaAuthBackendUser; received %#v (a %T)", val, val)
		}
	}
