...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "deferInitialCreds", GoGetter: "DeferInitialCreds"},
			_jsii_.MemberProperty{JsiiProperty: "deferInitialCredsInput", GoGetter: "DeferInitialCredsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDeferInitialCreds", GoMethod: "ResetDeferInitialCreds"},
