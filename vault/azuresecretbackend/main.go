...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRootPasswordTtl", GoMethod: "ResetRootPasswordTtl"},
			...
			_jsii_.MemberProperty{JsiiProperty: "rootPasswordTtl", GoGetter: "RootPasswordTtl"},
			_jsii_.MemberProperty{JsiiProperty: "rootPasswordTtlInput", GoGetter: "RootPasswordTtlInput"},
