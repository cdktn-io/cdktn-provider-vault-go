...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AwsSecretBackendStaticRole)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "assumeRoleSessionName", GoGetter: "AssumeRoleSessionName"},
			_jsii_.MemberProperty{JsiiProperty: "assumeRoleSessionNameInput", GoGetter: "AssumeRoleSessionNameInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAssumeRoleArn", GoMethod: "ResetAssumeRoleArn"},
			_jsii_.MemberMethod{JsiiMethod: "resetAssumeRoleSessionName", GoMethod: "ResetAssumeRoleSessionName"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AwsSecretBackendStaticRoleConfig)(nil)).Elem(),
	)
}
