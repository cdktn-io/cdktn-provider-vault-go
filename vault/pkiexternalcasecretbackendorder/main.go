...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PkiExternalCaSecretBackendOrder)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "challenges", GoGetter: "Challenges"},
			...
			_jsii_.MemberProperty{JsiiProperty: "nextWorkDate", GoGetter: "NextWorkDate"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberProperty{JsiiProperty: "orderId", GoGetter: "OrderId"},
			_jsii_.MemberProperty{JsiiProperty: "orderStatus", GoGetter: "OrderStatus"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetCsr", GoMethod: "ResetCsr"},
			_jsii_.MemberMethod{JsiiMethod: "resetIdentifiers", GoMethod: "ResetIdentifiers"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*PkiExternalCaSecretBackendOrderConfig)(nil)).Elem(),
	)
}
