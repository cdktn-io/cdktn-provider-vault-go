...
import (
	...
	"github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/transformrole/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/transform_role vault_transform_role}.
...
func (j *jsiiProxy_TransformRole) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_TransformRole) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_TransformRole) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_TransformRole) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_TransformRole) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/transform_role vault_transform_role} Resource.
func NewTransformRole(scope constructs.Construct, id *string, config *TransformRoleConfig) TransformRole {
	_init_.Initialize()

	if err := validateNewTransformRoleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_TransformRole)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_TransformRole)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_TransformRole)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a TransformRole resource upon running "cdktn plan <stack-name>".
func TransformRole_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateTransformRole_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func TransformRole_IsConstruct(x interface{}) *bool {
	...
	if err := validateTransformRole_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func TransformRole_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTransformRole_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func TransformRole_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTransformRole_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (t *jsiiProxy_TransformRole) AddMoveTarget(moveTarget *string) {
...
func (t *jsiiProxy_TransformRole) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransformRole) HasResourceMove() interface{} {
	var returns interface{}
...
func (t *jsiiProxy_TransformRole) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (t *jsiiProxy_TransformRole) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TransformRole) MoveFromId(id *string) {
...
func (t *jsiiProxy_TransformRole) MoveTo(moveTarget *string, index interface{}) {
...
func (t *jsiiProxy_TransformRole) MoveToId(id *string) {
...
func (t *jsiiProxy_TransformRole) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (t *jsiiProxy_TransformRole) ToHclTerraform() interface{} {
	var returns interface{}
...
func (t *jsiiProxy_TransformRole) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
