...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PkiExternalCaSecretBackendOrderChallengeFulfilled)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*PkiExternalCaSecretBackendOrderChallengeFulfilledConfig)(nil)).Elem(),
	)
}
