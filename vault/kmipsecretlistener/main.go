...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*KmipSecretListener)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "additionalClientCas", GoGetter: "AdditionalClientCas"},
			_jsii_.MemberProperty{JsiiProperty: "additionalClientCasInput", GoGetter: "AdditionalClientCasInput"},
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "address", GoGetter: "Address"},
			_jsii_.MemberProperty{JsiiProperty: "addressInput", GoGetter: "AddressInput"},
			_jsii_.MemberProperty{JsiiProperty: "alsoUseLegacyCa", GoGetter: "AlsoUseLegacyCa"},
			_jsii_.MemberProperty{JsiiProperty: "alsoUseLegacyCaInput", GoGetter: "AlsoUseLegacyCaInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAdditionalClientCas", GoMethod: "ResetAdditionalClientCas"},
			_jsii_.MemberMethod{JsiiMethod: "resetAlsoUseLegacyCa", GoMethod: "ResetAlsoUseLegacyCa"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*KmipSecretListenerConfig)(nil)).Elem(),
	)
}
