...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SshSecretBackendCa)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "generateSigningKey", GoGetter: "GenerateSigningKey"},
			_jsii_.MemberProperty{JsiiProperty: "generateSigningKeyInput", GoGetter: "GenerateSigningKeyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetGenerateSigningKey", GoMethod: "ResetGenerateSigningKey"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SshSecretBackendCaConfig)(nil)).Elem(),
	)
}
