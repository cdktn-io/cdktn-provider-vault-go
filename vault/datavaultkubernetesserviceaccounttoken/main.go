...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVaultKubernetesServiceAccountToken)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "clusterRoleBinding", GoGetter: "ClusterRoleBinding"},
			_jsii_.MemberProperty{JsiiProperty: "clusterRoleBindingInput", GoGetter: "ClusterRoleBindingInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetClusterRoleBinding", GoMethod: "ResetClusterRoleBinding"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVaultKubernetesServiceAccountTokenConfig)(nil)).Elem(),
	)
}
