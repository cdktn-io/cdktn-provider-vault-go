...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ConfigControlGroup)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-vault.configControlGroup.ConfigControlGroupConfig",
		reflect.TypeOf((*ConfigControlGroupConfig)(nil)).Elem(),
	)
}
