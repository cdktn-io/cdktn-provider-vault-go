...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RadiusAuthBackendUser)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-vault.radiusAuthBackendUser.RadiusAuthBackendUserConfig",
		reflect.TypeOf((*RadiusAuthBackendUserConfig)(nil)).Elem(),
	)
}
