...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "queueCapacity", GoGetter: "QueueCapacity"},
			_jsii_.MemberProperty{JsiiProperty: "queueCapacityInput", GoGetter: "QueueCapacityInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetQueueCapacity", GoMethod: "ResetQueueCapacity"},
