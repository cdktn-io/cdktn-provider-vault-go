...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "staticAccount", GoGetter: "StaticAccount"},
			_jsii_.MemberProperty{JsiiProperty: "staticAccountInput", GoGetter: "StaticAccountInput"},
