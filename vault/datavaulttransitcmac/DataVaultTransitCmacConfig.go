...
type DataVaultTransitCmacConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_cmac#name DataVaultTransitCmac#name}
	Name *string `field:"required" json:"name" yaml:"name"`
	// The Transit secret backend the key belongs to.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_cmac#path DataVaultTransitCmac#path}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_cmac#batch_results DataVaultTransitCmac#batch_results}
	BatchResults interface{} `field:"optional" json:"batchResults" yaml:"batchResults"`
	// The CMAC returned from Vault if using input.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_cmac#cmac DataVaultTransitCmac#cmac}
	Cmac *string `field:"optional" json:"cmac" yaml:"cmac"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_cmac#id DataVaultTransitCmac#id}.
	//
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_cmac#input DataVaultTransitCmac#input}
	Input *string `field:"optional" json:"input" yaml:"input"`
	// The version of the key to use.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_cmac#key_version DataVaultTransitCmac#key_version}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_cmac#mac_length DataVaultTransitCmac#mac_length}
	MacLength *float64 `field:"optional" json:"macLength" yaml:"macLength"`
	// Target namespace. (requires Enterprise).
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_cmac#namespace DataVaultTransitCmac#namespace}
