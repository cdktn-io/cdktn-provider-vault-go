...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IdentityGroupMemberEntityIds)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "exclusive", GoGetter: "Exclusive"},
			_jsii_.MemberProperty{JsiiProperty: "exclusiveInput", GoGetter: "ExclusiveInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExclusive", GoMethod: "ResetExclusive"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*IdentityGroupMemberEntityIdsConfig)(nil)).Elem(),
	)
}
