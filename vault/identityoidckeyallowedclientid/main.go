...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IdentityOidcKeyAllowedClientId)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "allowedClientId", GoGetter: "AllowedClientId"},
			_jsii_.MemberProperty{JsiiProperty: "allowedClientIdInput", GoGetter: "AllowedClientIdInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*IdentityOidcKeyAllowedClientIdConfig)(nil)).Elem(),
	)
}
