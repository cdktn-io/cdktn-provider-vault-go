...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "maxParallel", GoGetter: "MaxParallel"},
			_jsii_.MemberProperty{JsiiProperty: "maxParallelInput", GoGetter: "MaxParallelInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMaxParallel", GoMethod: "ResetMaxParallel"},
