...
func (j *jsiiProxy_ManagedKeysAwsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewManagedKeysAwsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ManagedKeysAwsList {
	_init_.Initialize()
...
func NewManagedKeysAwsList_Override(m ManagedKeysAwsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ManagedKeysAwsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_ManagedKeysAwsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_ManagedKeysAwsList) Resolve(context cdktn.IResolveContext) interface{} {
