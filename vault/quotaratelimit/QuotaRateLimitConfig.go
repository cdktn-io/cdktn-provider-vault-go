...
type QuotaRateLimitConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.7.0/docs/resources/quota_rate_limit#name QuotaRateLimit#name}
	Name *string `field:"required" json:"name" yaml:"name"`
	// The maximum number of requests at any given second to be allowed by the quota rule.
	//
	// The rate must be positive.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.7.0/docs/resources/quota_rate_limit#rate QuotaRateLimit#rate}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.7.0/docs/resources/quota_rate_limit#block_interval QuotaRateLimit#block_interval}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.7.0/docs/resources/quota_rate_limit#group_by QuotaRateLimit#group_by}
	GroupBy *string `field:"optional" json:"groupBy" yaml:"groupBy"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.7.0/docs/resources/quota_rate_limit#id QuotaRateLimit#id}.
	//
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.7.0/docs/resources/quota_rate_limit#inheritable QuotaRateLimit#inheritable}
	Inheritable interface{} `field:"optional" json:"inheritable" yaml:"inheritable"`
	// The duration in seconds to enforce rate limiting for.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.7.0/docs/resources/quota_rate_limit#interval QuotaRateLimit#interval}
	Interval *float64 `field:"optional" json:"interval" yaml:"interval"`
	// Target namespace. (requires Enterprise).
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.7.0/docs/resources/quota_rate_limit#namespace QuotaRateLimit#namespace}
	Namespace *string `field:"optional" json:"namespace" yaml:"namespace"`
	// Path of the mount or namespace to apply the quota. A blank path configures a global rate limit quota.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.7.0/docs/resources/quota_rate_limit#path QuotaRateLimit#path}
	Path *string `field:"optional" json:"path" yaml:"path"`
	// If set on a quota where path is set to an auth mount with a concept of roles (such as /auth/approle/), this will make the quota restrict login requests to that mount that are made with the specified role.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.7.0/docs/resources/quota_rate_limit#role QuotaRateLimit#role}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.7.0/docs/resources/quota_rate_limit#secondary_rate QuotaRateLimit#secondary_rate}
