...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVaultGenericSecret)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetWithLeaseStartTime", GoMethod: "ResetWithLeaseStartTime"},
			...
			_jsii_.MemberProperty{JsiiProperty: "withLeaseStartTime", GoGetter: "WithLeaseStartTime"},
			_jsii_.MemberProperty{JsiiProperty: "withLeaseStartTimeInput", GoGetter: "WithLeaseStartTimeInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVaultGenericSecretConfig)(nil)).Elem(),
	)
}
