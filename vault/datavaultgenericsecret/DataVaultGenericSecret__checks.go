...
func validateDataVaultGenericSecret_IsTerraformDataSourceParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func validateDataVaultGenericSecret_IsTerraformElementParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func (j *jsiiProxy_DataVaultGenericSecret) validateSetCountParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_DataVaultGenericSecret) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
