...
func validateDataVaultIdentityOidcClientCreds_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
...
func (j *jsiiProxy_DataVaultIdentityOidcClientCreds) validateSetCountParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_DataVaultIdentityOidcClientCreds) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
