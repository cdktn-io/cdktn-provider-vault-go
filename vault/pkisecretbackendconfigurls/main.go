...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PkiSecretBackendConfigUrls)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enableTemplating", GoGetter: "EnableTemplating"},
			_jsii_.MemberProperty{JsiiProperty: "enableTemplatingInput", GoGetter: "EnableTemplatingInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnableTemplating", GoMethod: "ResetEnableTemplating"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*PkiSecretBackendConfigUrlsConfig)(nil)).Elem(),
	)
}
