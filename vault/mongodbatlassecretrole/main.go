...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MongodbatlasSecretRole)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "projectRoles", GoGetter: "ProjectRoles"},
			_jsii_.MemberProperty{JsiiProperty: "projectRolesInput", GoGetter: "ProjectRolesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetProjectRoles", GoMethod: "ResetProjectRoles"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*MongodbatlasSecretRoleConfig)(nil)).Elem(),
	)
}
