...
import (
	...
	"github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/mfatotp/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/mfa_totp vault_mfa_totp}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/mfa_totp vault_mfa_totp} Resource.
...
func (m *jsiiProxy_MfaTotp) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MfaTotp) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MfaTotp) MoveFromId(id *string) {
...
func (m *jsiiProxy_MfaTotp) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MfaTotp) MoveToId(id *string) {
...
func (m *jsiiProxy_MfaTotp) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MfaTotp) ToHclTerraform() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MfaTotp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
