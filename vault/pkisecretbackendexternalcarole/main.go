...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PkiSecretBackendExternalCaRole)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-vault.pkiSecretBackendExternalCaRole.PkiSecretBackendExternalCaRoleConfig",
		reflect.TypeOf((*PkiSecretBackendExternalCaRoleConfig)(nil)).Elem(),
	)
}
