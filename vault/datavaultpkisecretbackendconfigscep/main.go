...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVaultPkiSecretBackendConfigScep)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVaultPkiSecretBackendConfigScepAuthenticators)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-vault.dataVaultPkiSecretBackendConfigScep.DataVaultPkiSecretBackendConfigScepAuthenticatorsList",
		reflect.TypeOf((*DataVaultPkiSecretBackendConfigScepAuthenticatorsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVaultPkiSecretBackendConfigScepAuthenticatorsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVaultPkiSecretBackendConfigScepExternalValidationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
