...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AlicloudSecretBackendRole)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "inlinePolicies", GoGetter: "InlinePolicies"},
			_jsii_.MemberProperty{JsiiProperty: "inlinePoliciesInput", GoGetter: "InlinePoliciesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putInlinePolicies", GoMethod: "PutInlinePolicies"},
			_jsii_.MemberMethod{JsiiMethod: "putRemotePolicies", GoMethod: "PutRemotePolicies"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberProperty{JsiiProperty: "remotePolicies", GoGetter: "RemotePolicies"},
			_jsii_.MemberProperty{JsiiProperty: "remotePoliciesInput", GoGetter: "RemotePoliciesInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetInlinePolicies", GoMethod: "ResetInlinePolicies"},
			_jsii_.MemberMethod{JsiiMethod: "resetMaxTtl", GoMethod: "ResetMaxTtl"},
			_jsii_.MemberMethod{JsiiMethod: "resetNamespace", GoMethod: "ResetNamespace"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRemotePolicies", GoMethod: "ResetRemotePolicies"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AlicloudSecretBackendRoleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-vault.alicloudSecretBackendRole.AlicloudSecretBackendRoleInlinePolicies",
		reflect.TypeOf((*AlicloudSecretBackendRoleInlinePolicies)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-vault.alicloudSecretBackendRole.AlicloudSecretBackendRoleInlinePoliciesList",
		reflect.TypeOf((*AlicloudSecretBackendRoleInlinePoliciesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AlicloudSecretBackendRoleInlinePoliciesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AlicloudSecretBackendRoleRemotePolicies)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-vault.alicloudSecretBackendRole.AlicloudSecretBackendRoleRemotePoliciesList",
		reflect.TypeOf((*AlicloudSecretBackendRoleRemotePoliciesList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AlicloudSecretBackendRoleRemotePoliciesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_AlicloudSecretBackendRoleRemotePoliciesOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
