...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GcpAuthBackendRole)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "addGroupAliases", GoGetter: "AddGroupAliases"},
			_jsii_.MemberProperty{JsiiProperty: "addGroupAliasesInput", GoGetter: "AddGroupAliasesInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "allowGceInference", GoGetter: "AllowGceInference"},
			_jsii_.MemberProperty{JsiiProperty: "allowGceInferenceInput", GoGetter: "AllowGceInferenceInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "boundInstanceGroupsInput", GoGetter: "BoundInstanceGroupsInput"},
			_jsii_.MemberProperty{JsiiProperty: "boundLabels", GoGetter: "BoundLabels"},
			_jsii_.MemberProperty{JsiiProperty: "boundLabelsInput", GoGetter: "BoundLabelsInput"},
			_jsii_.MemberProperty{JsiiProperty: "boundProjects", GoGetter: "BoundProjects"},
			_jsii_.MemberProperty{JsiiProperty: "boundProjectsInput", GoGetter: "BoundProjectsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "boundServiceAccountsInput", GoGetter: "BoundServiceAccountsInput"},
			_jsii_.MemberProperty{JsiiProperty: "boundZones", GoGetter: "BoundZones"},
			_jsii_.MemberProperty{JsiiProperty: "boundZonesInput", GoGetter: "BoundZonesInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "maxJwtExp", GoGetter: "MaxJwtExp"},
			_jsii_.MemberProperty{JsiiProperty: "maxJwtExpInput", GoGetter: "MaxJwtExpInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAddGroupAliases", GoMethod: "ResetAddGroupAliases"},
			_jsii_.MemberMethod{JsiiMethod: "resetAliasMetadata", GoMethod: "ResetAliasMetadata"},
			_jsii_.MemberMethod{JsiiMethod: "resetAllowGceInference", GoMethod: "ResetAllowGceInference"},
			_jsii_.MemberMethod{JsiiMethod: "resetBackend", GoMethod: "ResetBackend"},
			_jsii_.MemberMethod{JsiiMethod: "resetBoundInstanceGroups", GoMethod: "ResetBoundInstanceGroups"},
			_jsii_.MemberMethod{JsiiMethod: "resetBoundLabels", GoMethod: "ResetBoundLabels"},
			_jsii_.MemberMethod{JsiiMethod: "resetBoundProjects", GoMethod: "ResetBoundProjects"},
			_jsii_.MemberMethod{JsiiMethod: "resetBoundRegions", GoMethod: "ResetBoundRegions"},
			_jsii_.MemberMethod{JsiiMethod: "resetBoundServiceAccounts", GoMethod: "ResetBoundServiceAccounts"},
			_jsii_.MemberMethod{JsiiMethod: "resetBoundZones", GoMethod: "ResetBoundZones"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetMaxJwtExp", GoMethod: "ResetMaxJwtExp"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GcpAuthBackendRoleConfig)(nil)).Elem(),
	)
}
