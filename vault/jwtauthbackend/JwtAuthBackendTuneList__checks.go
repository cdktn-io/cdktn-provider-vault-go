...
func (j *jsiiProxy_JwtAuthBackendTuneList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*JwtAuthBackendTune:
		val := val.(*[]*JwtAuthBackendTune)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*JwtAuthBackendTune; received %#v (a %T)", val, val)
		}
	}
