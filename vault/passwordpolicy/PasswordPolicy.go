...
import (
	...
	"github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/passwordpolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/password_policy vault_password_policy}.
type PasswordPolicy interface {
	...
	SetEntropySource(val *string)
	EntropySourceInput() *string
	// Experimental.
...
func (j *jsiiProxy_PasswordPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PasswordPolicy) EntropySource() *string {
	var returns *string
	_jsii_.Get(
		j,
		"entropySource",
...
func (j *jsiiProxy_PasswordPolicy) EntropySourceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"entropySourceInput",
...
func (j *jsiiProxy_PasswordPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PasswordPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PasswordPolicy) Namespace() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespace",
...
func (j *jsiiProxy_PasswordPolicy) NamespaceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespaceInput",
...
func (j *jsiiProxy_PasswordPolicy) Policy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policy",
...
func (j *jsiiProxy_PasswordPolicy) PolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyInput",
...
func (j *jsiiProxy_PasswordPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PasswordPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/password_policy vault_password_policy} Resource.
...
func (j *jsiiProxy_PasswordPolicy)SetEntropySource(val *string) {
	if err := j.validateSetEntropySourceParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_PasswordPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PasswordPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PasswordPolicy)SetNamespace(val *string) {
...
func (j *jsiiProxy_PasswordPolicy)SetPolicy(val *string) {
...
func (j *jsiiProxy_PasswordPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PasswordPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PasswordPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PasswordPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PasswordPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PasswordPolicy) ResetEntropySource() {
	_jsii_.InvokeVoid(
		p,
		"resetEntropySource",
		nil, // no parameters
...
func (p *jsiiProxy_PasswordPolicy) ResetNamespace() {
	_jsii_.InvokeVoid(
		p,
		"resetNamespace",
		nil, // no parameters
...
func (p *jsiiProxy_PasswordPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
