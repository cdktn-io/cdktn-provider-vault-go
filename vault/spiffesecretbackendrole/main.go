...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SpiffeSecretBackendRole)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUseJtiClaim", GoMethod: "ResetUseJtiClaim"},
			...
			_jsii_.MemberProperty{JsiiProperty: "useJtiClaim", GoGetter: "UseJtiClaim"},
			_jsii_.MemberProperty{JsiiProperty: "useJtiClaimInput", GoGetter: "UseJtiClaimInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SpiffeSecretBackendRoleConfig)(nil)).Elem(),
	)
}
