...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OciAuthBackendRole)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ocidList", GoGetter: "OcidList"},
			_jsii_.MemberProperty{JsiiProperty: "ocidListInput", GoGetter: "OcidListInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOcidList", GoMethod: "ResetOcidList"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OciAuthBackendRoleConfig)(nil)).Elem(),
	)
}
