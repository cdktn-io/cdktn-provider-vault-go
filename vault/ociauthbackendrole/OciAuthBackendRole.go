...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/oci_auth_backend_role vault_oci_auth_backend_role}.
...
func (j *jsiiProxy_OciAuthBackendRole) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_OciAuthBackendRole) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_OciAuthBackendRole) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_OciAuthBackendRole) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_OciAuthBackendRole) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/oci_auth_backend_role vault_oci_auth_backend_role} Resource.
...
func (j *jsiiProxy_OciAuthBackendRole)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_OciAuthBackendRole)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_OciAuthBackendRole)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func OciAuthBackendRole_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (o *jsiiProxy_OciAuthBackendRole) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OciAuthBackendRole) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (o *jsiiProxy_OciAuthBackendRole) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
