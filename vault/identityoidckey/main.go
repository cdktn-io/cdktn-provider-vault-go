...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IdentityOidcKey)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetVerificationTtl", GoMethod: "ResetVerificationTtl"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*IdentityOidcKeyConfig)(nil)).Elem(),
	)
}
