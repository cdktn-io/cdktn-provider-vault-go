...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "boundServiceAccountNamespaceSelectorInput", GoGetter: "BoundServiceAccountNamespaceSelectorInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBoundServiceAccountNamespaces", GoMethod: "ResetBoundServiceAccountNamespaces"},
			_jsii_.MemberMethod{JsiiMethod: "resetBoundServiceAccountNamespaceSelector", GoMethod: "ResetBoundServiceAccountNamespaceSelector"},
