...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allowedParameterInput", GoGetter: "AllowedParameterInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "deniedParameter", GoGetter: "DeniedParameter"},
			_jsii_.MemberProperty{JsiiProperty: "deniedParameterInput", GoGetter: "DeniedParameterInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "maxWrappingTtl", GoGetter: "MaxWrappingTtl"},
			_jsii_.MemberProperty{JsiiProperty: "maxWrappingTtlInput", GoGetter: "MaxWrappingTtlInput"},
			_jsii_.MemberProperty{JsiiProperty: "minWrappingTtl", GoGetter: "MinWrappingTtl"},
			_jsii_.MemberProperty{JsiiProperty: "minWrappingTtlInput", GoGetter: "MinWrappingTtlInput"},
			_jsii_.MemberProperty{JsiiProperty: "path", GoGetter: "Path"},
			_jsii_.MemberProperty{JsiiProperty: "pathInput", GoGetter: "PathInput"},
			_jsii_.MemberMethod{JsiiMethod: "putAllowedParameter", GoMethod: "PutAllowedParameter"},
			_jsii_.MemberMethod{JsiiMethod: "putDeniedParameter", GoMethod: "PutDeniedParameter"},
			_jsii_.MemberProperty{JsiiProperty: "requiredParameters", GoGetter: "RequiredParameters"},
			_jsii_.MemberProperty{JsiiProperty: "requiredParametersInput", GoGetter: "RequiredParametersInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetAllowedParameter", GoMethod: "ResetAllowedParameter"},
			_jsii_.MemberMethod{JsiiMethod: "resetDeniedParameter", GoMethod: "ResetDeniedParameter"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetMaxWrappingTtl", GoMethod: "ResetMaxWrappingTtl"},
			_jsii_.MemberMethod{JsiiMethod: "resetMinWrappingTtl", GoMethod: "ResetMinWrappingTtl"},
			_jsii_.MemberMethod{JsiiMethod: "resetRequiredParameters", GoMethod: "ResetRequiredParameters"},
			_jsii_.MemberMethod{JsiiMethod: "resetSubscribeEventTypes", GoMethod: "ResetSubscribeEventTypes"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "subscribeEventTypes", GoGetter: "SubscribeEventTypes"},
			_jsii_.MemberProperty{JsiiProperty: "subscribeEventTypesInput", GoGetter: "SubscribeEventTypesInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
