...
func (j *jsiiProxy_PkiSecretBackendConfigScepExternalValidationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPkiSecretBackendConfigScepExternalValidationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PkiSecretBackendConfigScepExternalValidationList {
	_init_.Initialize()
...
func NewPkiSecretBackendConfigScepExternalValidationList_Override(p PkiSecretBackendConfigScepExternalValidationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PkiSecretBackendConfigScepExternalValidationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PkiSecretBackendConfigScepExternalValidationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PkiSecretBackendConfigScepExternalValidationList) Resolve(context cdktn.IResolveContext) interface{} {
