...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allowedDigestAlgorithms", GoGetter: "AllowedDigestAlgorithms"},
			_jsii_.MemberProperty{JsiiProperty: "allowedDigestAlgorithmsInput", GoGetter: "AllowedDigestAlgorithmsInput"},
			_jsii_.MemberProperty{JsiiProperty: "allowedEncryptionAlgorithms", GoGetter: "AllowedEncryptionAlgorithms"},
			_jsii_.MemberProperty{JsiiProperty: "allowedEncryptionAlgorithmsInput", GoGetter: "AllowedEncryptionAlgorithmsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "externalValidation", GoGetter: "ExternalValidation"},
			_jsii_.MemberProperty{JsiiProperty: "externalValidationInput", GoGetter: "ExternalValidationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putExternalValidation", GoMethod: "PutExternalValidation"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAllowedDigestAlgorithms", GoMethod: "ResetAllowedDigestAlgorithms"},
			_jsii_.MemberMethod{JsiiMethod: "resetAllowedEncryptionAlgorithms", GoMethod: "ResetAllowedEncryptionAlgorithms"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExternalValidation", GoMethod: "ResetExternalValidation"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetLogLevel", GoMethod: "ResetLogLevel"},
			_jsii_.MemberMethod{JsiiMethod: "resetNamespace", GoMethod: "ResetNamespace"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRestrictCaChainToIssuer", GoMethod: "ResetRestrictCaChainToIssuer"},
			_jsii_.MemberProperty{JsiiProperty: "restrictCaChainToIssuer", GoGetter: "RestrictCaChainToIssuer"},
			_jsii_.MemberProperty{JsiiProperty: "restrictCaChainToIssuerInput", GoGetter: "RestrictCaChainToIssuerInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetScep", GoMethod: "ResetScep"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "scep", GoGetter: "Scep"},
			_jsii_.MemberProperty{JsiiProperty: "scepInput", GoGetter: "ScepInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "intune", GoGetter: "Intune"},
			_jsii_.MemberProperty{JsiiProperty: "intuneInput", GoGetter: "IntuneInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetIntune", GoMethod: "ResetIntune"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
