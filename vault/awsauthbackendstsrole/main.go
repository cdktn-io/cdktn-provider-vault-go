...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AwsAuthBackendStsRole)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "stsRole", GoGetter: "StsRole"},
			_jsii_.MemberProperty{JsiiProperty: "stsRoleInput", GoGetter: "StsRoleInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AwsAuthBackendStsRoleConfig)(nil)).Elem(),
	)
}
