...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/identity_mfa_totp vault_identity_mfa_totp}.
...
func (j *jsiiProxy_IdentityMfaTotp) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IdentityMfaTotp) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IdentityMfaTotp) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IdentityMfaTotp) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IdentityMfaTotp) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/identity_mfa_totp vault_identity_mfa_totp} Resource.
...
func (j *jsiiProxy_IdentityMfaTotp)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IdentityMfaTotp)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IdentityMfaTotp)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a IdentityMfaTotp resource upon running "cdktn plan <stack-name>".
func IdentityMfaTotp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateIdentityMfaTotp_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IdentityMfaTotp) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IdentityMfaTotp) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IdentityMfaTotp) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IdentityMfaTotp) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IdentityMfaTotp) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IdentityMfaTotp) MoveFromId(id *string) {
...
func (i *jsiiProxy_IdentityMfaTotp) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_IdentityMfaTotp) MoveToId(id *string) {
...
func (i *jsiiProxy_IdentityMfaTotp) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IdentityMfaTotp) ToHclTerraform() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IdentityMfaTotp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
