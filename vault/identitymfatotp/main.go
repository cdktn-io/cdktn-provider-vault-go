...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IdentityMfaTotp)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "qrSize", GoGetter: "QrSize"},
			_jsii_.MemberProperty{JsiiProperty: "qrSizeInput", GoGetter: "QrSizeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetQrSize", GoMethod: "ResetQrSize"},
			_jsii_.MemberMethod{JsiiMethod: "resetSkew", GoMethod: "ResetSkew"},
			_jsii_.MemberProperty{JsiiProperty: "skew", GoGetter: "Skew"},
			_jsii_.MemberProperty{JsiiProperty: "skewInput", GoGetter: "SkewInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*IdentityMfaTotpConfig)(nil)).Elem(),
	)
}
