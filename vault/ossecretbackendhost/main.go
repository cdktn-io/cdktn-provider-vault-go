...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OsSecretBackendHost)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSshHostKey", GoMethod: "ResetSshHostKey"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sshHostKey", GoGetter: "SshHostKey"},
			_jsii_.MemberProperty{JsiiProperty: "sshHostKeyInput", GoGetter: "SshHostKeyInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OsSecretBackendHostConfig)(nil)).Elem(),
	)
}
