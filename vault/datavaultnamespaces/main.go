...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVaultNamespaces)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "pathsFq", GoGetter: "PathsFq"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVaultNamespacesConfig)(nil)).Elem(),
	)
}
