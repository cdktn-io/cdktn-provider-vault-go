...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ocspCaCertificates", GoGetter: "OcspCaCertificates"},
			_jsii_.MemberProperty{JsiiProperty: "ocspCaCertificatesInput", GoGetter: "OcspCaCertificatesInput"},
			_jsii_.MemberProperty{JsiiProperty: "ocspEnabled", GoGetter: "OcspEnabled"},
