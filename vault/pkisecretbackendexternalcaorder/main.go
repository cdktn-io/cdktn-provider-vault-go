...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PkiSecretBackendExternalCaOrder)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-vault.pkiSecretBackendExternalCaOrder.PkiSecretBackendExternalCaOrderConfig",
		reflect.TypeOf((*PkiSecretBackendExternalCaOrderConfig)(nil)).Elem(),
	)
}
