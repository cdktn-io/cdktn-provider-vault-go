...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "pathFq", GoGetter: "PathFq"},
			_jsii_.MemberProperty{JsiiProperty: "pathFqInput", GoGetter: "PathFqInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPathFq", GoMethod: "ResetPathFq"},
