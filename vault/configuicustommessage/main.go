...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ConfigUiCustomMessage)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "authenticated", GoGetter: "Authenticated"},
			_jsii_.MemberProperty{JsiiProperty: "authenticatedInput", GoGetter: "AuthenticatedInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "messageBase64", GoGetter: "MessageBase64"},
			_jsii_.MemberProperty{JsiiProperty: "messageBase64Input", GoGetter: "MessageBase64Input"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAuthenticated", GoMethod: "ResetAuthenticated"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ConfigUiCustomMessageConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-vault.configUiCustomMessage.ConfigUiCustomMessageLink",
		reflect.TypeOf((*ConfigUiCustomMessageLink)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-vault.configUiCustomMessage.ConfigUiCustomMessageLinkOutputReference",
		reflect.TypeOf((*ConfigUiCustomMessageLinkOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
