...
import (
	...
	"github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/transitsecretbackendkey/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/transit_secret_backend_key vault_transit_secret_backend_key} Resource.
...
func (t *jsiiProxy_TransitSecretBackendKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
