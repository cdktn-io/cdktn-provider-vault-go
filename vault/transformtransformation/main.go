...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "convergent", GoGetter: "Convergent"},
			_jsii_.MemberProperty{JsiiProperty: "convergentInput", GoGetter: "ConvergentInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetConvergent", GoMethod: "ResetConvergent"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetStores", GoMethod: "ResetStores"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTweakSource", GoMethod: "ResetTweakSource"},
			_jsii_.MemberMethod{JsiiMethod: "resetType", GoMethod: "ResetType"},
			_jsii_.MemberProperty{JsiiProperty: "stores", GoGetter: "Stores"},
			_jsii_.MemberProperty{JsiiProperty: "storesInput", GoGetter: "StoresInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tweakSource", GoGetter: "TweakSource"},
			_jsii_.MemberProperty{JsiiProperty: "tweakSourceInput", GoGetter: "TweakSourceInput"},
