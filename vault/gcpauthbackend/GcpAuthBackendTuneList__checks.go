...
func (j *jsiiProxy_GcpAuthBackendTuneList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*GcpAuthBackendTune:
		val := val.(*[]*GcpAuthBackendTune)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*GcpAuthBackendTune; received %#v (a %T)", val, val)
		}
	}
