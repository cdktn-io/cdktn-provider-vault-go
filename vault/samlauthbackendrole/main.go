...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "boundAttributesTypeInput", GoGetter: "BoundAttributesTypeInput"},
			_jsii_.MemberProperty{JsiiProperty: "boundSubjects", GoGetter: "BoundSubjects"},
			_jsii_.MemberProperty{JsiiProperty: "boundSubjectsInput", GoGetter: "BoundSubjectsInput"},
			_jsii_.MemberProperty{JsiiProperty: "boundSubjectsType", GoGetter: "BoundSubjectsType"},
			_jsii_.MemberProperty{JsiiProperty: "boundSubjectsTypeInput", GoGetter: "BoundSubjectsTypeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBoundSubjectsType", GoMethod: "ResetBoundSubjectsType"},
