...
type IdentityOidcClientConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/resources/identity_oidc_client#name IdentityOidcClient#name}
	Name *string `field:"required" json:"name" yaml:"name"`
	// The time-to-live for access tokens obtained by the client.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/resources/identity_oidc_client#access_token_ttl IdentityOidcClient#access_token_ttl}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/resources/identity_oidc_client#assignments IdentityOidcClient#assignments}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/resources/identity_oidc_client#client_type IdentityOidcClient#client_type}
	ClientType *string `field:"optional" json:"clientType" yaml:"clientType"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/resources/identity_oidc_client#id IdentityOidcClient#id}.
	//
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/resources/identity_oidc_client#key IdentityOidcClient#key}
	Key *string `field:"optional" json:"key" yaml:"key"`
	// Target namespace. (requires Enterprise).
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/resources/identity_oidc_client#namespace IdentityOidcClient#namespace}
