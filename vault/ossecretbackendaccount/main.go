...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OsSecretBackendAccount)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "lastVaultRotation", GoGetter: "LastVaultRotation"},
			...
			_jsii_.MemberProperty{JsiiProperty: "nextVaultRotation", GoGetter: "NextVaultRotation"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "parentAccountRef", GoGetter: "ParentAccountRef"},
			_jsii_.MemberProperty{JsiiProperty: "parentAccountRefInput", GoGetter: "ParentAccountRefInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetParentAccountRef", GoMethod: "ResetParentAccountRef"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OsSecretBackendAccountConfig)(nil)).Elem(),
	)
}
