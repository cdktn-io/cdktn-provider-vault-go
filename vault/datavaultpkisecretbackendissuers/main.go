...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVaultPkiSecretBackendIssuers)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "keyInfo", GoGetter: "KeyInfo"},
			_jsii_.MemberProperty{JsiiProperty: "keyInfoJson", GoGetter: "KeyInfoJson"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVaultPkiSecretBackendIssuersConfig)(nil)).Elem(),
	)
}
