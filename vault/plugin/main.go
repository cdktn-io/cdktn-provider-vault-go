...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ociImage", GoGetter: "OciImage"},
			_jsii_.MemberProperty{JsiiProperty: "ociImageInput", GoGetter: "OciImageInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOciImage", GoMethod: "ResetOciImage"},
