...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IdentityEntityAlias)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "canonicalId", GoGetter: "CanonicalId"},
			_jsii_.MemberProperty{JsiiProperty: "canonicalIdInput", GoGetter: "CanonicalIdInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*IdentityEntityAliasConfig)(nil)).Elem(),
	)
}
