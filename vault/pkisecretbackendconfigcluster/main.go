...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PkiSecretBackendConfigCluster)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "aiaPath", GoGetter: "AiaPath"},
			_jsii_.MemberProperty{JsiiProperty: "aiaPathInput", GoGetter: "AiaPathInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAiaPath", GoMethod: "ResetAiaPath"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*PkiSecretBackendConfigClusterConfig)(nil)).Elem(),
	)
}
