...
import (
	...
	"github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/rabbitmqsecretbackend/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/rabbitmq_secret_backend vault_rabbitmq_secret_backend}.
type RabbitmqSecretBackend interface {
	...
	SetConnectionUri(val *string)
	ConnectionUriInput() *string
	// Experimental.
...
func (j *jsiiProxy_RabbitmqSecretBackend) Connection() interface{} {
...
func (j *jsiiProxy_RabbitmqSecretBackend) ConnectionUri() *string {
	var returns *string
	_jsii_.Get(
		j,
		"connectionUri",
...
func (j *jsiiProxy_RabbitmqSecretBackend) ConnectionUriInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"connectionUriInput",
...
func (j *jsiiProxy_RabbitmqSecretBackend) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_RabbitmqSecretBackend) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_RabbitmqSecretBackend) DefaultLeaseTtlSeconds() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RabbitmqSecretBackend) DefaultLeaseTtlSecondsInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RabbitmqSecretBackend) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_RabbitmqSecretBackend) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_RabbitmqSecretBackend) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_RabbitmqSecretBackend) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_RabbitmqSecretBackend) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_RabbitmqSecretBackend) MaxLeaseTtlSeconds() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"maxLeaseTtlSeconds",
...
func (j *jsiiProxy_RabbitmqSecretBackend) MaxLeaseTtlSecondsInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RabbitmqSecretBackend) Namespace() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespace",
...
func (j *jsiiProxy_RabbitmqSecretBackend) NamespaceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespaceInput",
...
func (j *jsiiProxy_RabbitmqSecretBackend) Node() constructs.Node {
...
func (j *jsiiProxy_RabbitmqSecretBackend) Password() *string {
	var returns *string
	_jsii_.Get(
		j,
		"password",
...
func (j *jsiiProxy_RabbitmqSecretBackend) PasswordInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"passwordInput",
...
func (j *jsiiProxy_RabbitmqSecretBackend) PasswordPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"passwordPolicy",
...
func (j *jsiiProxy_RabbitmqSecretBackend) PasswordPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"passwordPolicyInput",
...
func (j *jsiiProxy_RabbitmqSecretBackend) PathInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pathInput",
...
func (j *jsiiProxy_RabbitmqSecretBackend) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_RabbitmqSecretBackend) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_RabbitmqSecretBackend) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RabbitmqSecretBackend) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RabbitmqSecretBackend) Username() *string {
	var returns *string
	_jsii_.Get(
		j,
		"username",
...
func (j *jsiiProxy_RabbitmqSecretBackend) UsernameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"usernameInput",
...
func (j *jsiiProxy_RabbitmqSecretBackend) UsernameTemplate() *string {
	var returns *string
	_jsii_.Get(
		j,
		"usernameTemplate",
...
func (j *jsiiProxy_RabbitmqSecretBackend) UsernameTemplateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RabbitmqSecretBackend) VerifyConnection() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"verifyConnection",
...
func (j *jsiiProxy_RabbitmqSecretBackend) VerifyConnectionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/rabbitmq_secret_backend vault_rabbitmq_secret_backend} Resource.
...
func (j *jsiiProxy_RabbitmqSecretBackend)SetCount(val interface{}) {
...
// Experimental.
func RabbitmqSecretBackend_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateRabbitmqSecretBackend_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func RabbitmqSecretBackend_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateRabbitmqSecretBackend_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func RabbitmqSecretBackend_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-vault.rabbitmqSecretBackend.RabbitmqSecretBackend",
...
func (r *jsiiProxy_RabbitmqSecretBackend) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RabbitmqSecretBackend) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_RabbitmqSecretBackend) MoveFromId(id *string) {
...
func (r *jsiiProxy_RabbitmqSecretBackend) MoveTo(moveTarget *string, index interface{}) {
...
func (r *jsiiProxy_RabbitmqSecretBackend) MoveToId(id *string) {
...
func (r *jsiiProxy_RabbitmqSecretBackend) ResetDescription() {
	_jsii_.InvokeVoid(
		r,
		"resetDescription",
		nil, // no parameters
...
func (r *jsiiProxy_RabbitmqSecretBackend) ResetMaxLeaseTtlSeconds() {
	_jsii_.InvokeVoid(
		r,
		"resetMaxLeaseTtlSeconds",
		nil, // no parameters
...
func (r *jsiiProxy_RabbitmqSecretBackend) ResetNamespace() {
	_jsii_.InvokeVoid(
		r,
		"resetNamespace",
		nil, // no parameters
...
func (r *jsiiProxy_RabbitmqSecretBackend) ResetPath() {
	_jsii_.InvokeVoid(
		r,
		"resetPath",
		nil, // no parameters
...
func (r *jsiiProxy_RabbitmqSecretBackend) ResetUsernameTemplate() {
	_jsii_.InvokeVoid(
		r,
		"resetUsernameTemplate",
		nil, // no parameters
...
func (r *jsiiProxy_RabbitmqSecretBackend) ResetVerifyConnection() {
	_jsii_.InvokeVoid(
		r,
		"resetVerifyConnection",
		nil, // no parameters
...
func (r *jsiiProxy_RabbitmqSecretBackend) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_RabbitmqSecretBackend) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_RabbitmqSecretBackend) ToHclTerraform() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_RabbitmqSecretBackend) ToMetadata() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_RabbitmqSecretBackend) ToString() *string {
	var returns *string
...
func (r *jsiiProxy_RabbitmqSecretBackend) ToTerraform() interface{} {
	var returns interface{}
