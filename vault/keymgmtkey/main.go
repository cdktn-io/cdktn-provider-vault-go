...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*KeymgmtKey)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "minEnabledVersion", GoGetter: "MinEnabledVersion"},
			_jsii_.MemberProperty{JsiiProperty: "minEnabledVersionInput", GoGetter: "MinEnabledVersionInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "replicaRegionsInput", GoGetter: "ReplicaRegionsInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetDeletionAllowed", GoMethod: "ResetDeletionAllowed"},
			_jsii_.MemberMethod{JsiiMethod: "resetMinEnabledVersion", GoMethod: "ResetMinEnabledVersion"},
			_jsii_.MemberMethod{JsiiMethod: "resetNamespace", GoMethod: "ResetNamespace"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetReplicaRegions", GoMethod: "ResetReplicaRegions"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*KeymgmtKeyConfig)(nil)).Elem(),
	)
}
