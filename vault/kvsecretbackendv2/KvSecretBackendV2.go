...
import (
	...
	"github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/kvsecretbackendv2/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/kv_secret_backend_v2 vault_kv_secret_backend_v2}.
...
func (j *jsiiProxy_KvSecretBackendV2) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_KvSecretBackendV2) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_KvSecretBackendV2) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KvSecretBackendV2) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_KvSecretBackendV2) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/kv_secret_backend_v2 vault_kv_secret_backend_v2} Resource.
...
func (j *jsiiProxy_KvSecretBackendV2)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KvSecretBackendV2)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KvSecretBackendV2)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func KvSecretBackendV2_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateKvSecretBackendV2_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KvSecretBackendV2) AddMoveTarget(moveTarget *string) {
...
func (k *jsiiProxy_KvSecretBackendV2) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KvSecretBackendV2) HasResourceMove() interface{} {
	var returns interface{}
...
func (k *jsiiProxy_KvSecretBackendV2) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (k *jsiiProxy_KvSecretBackendV2) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KvSecretBackendV2) MoveFromId(id *string) {
...
func (k *jsiiProxy_KvSecretBackendV2) MoveTo(moveTarget *string, index interface{}) {
...
func (k *jsiiProxy_KvSecretBackendV2) MoveToId(id *string) {
...
func (k *jsiiProxy_KvSecretBackendV2) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (k *jsiiProxy_KvSecretBackendV2) ToHclTerraform() interface{} {
	var returns interface{}
...
func (k *jsiiProxy_KvSecretBackendV2) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
