...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OsSecretBackend)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSshHostKeyTrustOnFirstUse", GoMethod: "ResetSshHostKeyTrustOnFirstUse"},
			_jsii_.MemberProperty{JsiiProperty: "sshHostKeyTrustOnFirstUse", GoGetter: "SshHostKeyTrustOnFirstUse"},
			_jsii_.MemberProperty{JsiiProperty: "sshHostKeyTrustOnFirstUseInput", GoGetter: "SshHostKeyTrustOnFirstUseInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OsSecretBackendConfig)(nil)).Elem(),
	)
}
