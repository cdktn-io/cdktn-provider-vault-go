...
type PkiSecretBackendConfigAcmeConfig struct {
	...
	ChallengeExcludedIpRanges *[]*string `field:"optional" json:"challengeExcludedIpRanges" yaml:"challengeExcludedIpRanges"`
	...
	ChallengePermittedIpRanges *[]*string `field:"optional" json:"challengePermittedIpRanges" yaml:"challengePermittedIpRanges"`
