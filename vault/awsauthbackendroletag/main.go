...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AwsAuthBackendRoleTag)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "allowInstanceMigration", GoGetter: "AllowInstanceMigration"},
			_jsii_.MemberProperty{JsiiProperty: "allowInstanceMigrationInput", GoGetter: "AllowInstanceMigrationInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "disallowReauthentication", GoGetter: "DisallowReauthentication"},
			_jsii_.MemberProperty{JsiiProperty: "disallowReauthenticationInput", GoGetter: "DisallowReauthenticationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAllowInstanceMigration", GoMethod: "ResetAllowInstanceMigration"},
			_jsii_.MemberMethod{JsiiMethod: "resetBackend", GoMethod: "ResetBackend"},
			_jsii_.MemberMethod{JsiiMethod: "resetDisallowReauthentication", GoMethod: "ResetDisallowReauthentication"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AwsAuthBackendRoleTagConfig)(nil)).Elem(),
	)
}
