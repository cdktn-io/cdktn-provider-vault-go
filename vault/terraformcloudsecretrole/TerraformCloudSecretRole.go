...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/terraform_cloud_secret_role vault_terraform_cloud_secret_role}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/terraform_cloud_secret_role vault_terraform_cloud_secret_role} Resource.
...
func (t *jsiiProxy_TerraformCloudSecretRole) AddMoveTarget(moveTarget *string) {
...
func (t *jsiiProxy_TerraformCloudSecretRole) HasResourceMove() interface{} {
	var returns interface{}
...
func (t *jsiiProxy_TerraformCloudSecretRole) MoveFromId(id *string) {
...
func (t *jsiiProxy_TerraformCloudSecretRole) MoveTo(moveTarget *string, index interface{}) {
...
func (t *jsiiProxy_TerraformCloudSecretRole) MoveToId(id *string) {
...
func (t *jsiiProxy_TerraformCloudSecretRole) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (t *jsiiProxy_TerraformCloudSecretRole) ToHclTerraform() interface{} {
	var returns interface{}
