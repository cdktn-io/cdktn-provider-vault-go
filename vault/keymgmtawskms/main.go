...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*KeymgmtAwsKms)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "keyCollection", GoGetter: "KeyCollection"},
			_jsii_.MemberProperty{JsiiProperty: "keyCollectionInput", GoGetter: "KeyCollectionInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*KeymgmtAwsKmsConfig)(nil)).Elem(),
	)
}
