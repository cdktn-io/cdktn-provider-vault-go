...
func (j *jsiiProxy_GcpSecretRoleset) BackendInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"backendInput",
...
func (j *jsiiProxy_GcpSecretRoleset) Binding() GcpSecretRolesetBindingList {
	var returns GcpSecretRolesetBindingList
	_jsii_.Get(
		j,
		"binding",
		&returns,
...
func (j *jsiiProxy_GcpSecretRoleset) BindingInput() interface{} {
...
func (j *jsiiProxy_GcpSecretRoleset) Connection() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"connection",
...
func (j *jsiiProxy_GcpSecretRoleset) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_GcpSecretRoleset) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GcpSecretRoleset) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GcpSecretRoleset) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GcpSecretRoleset) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GcpSecretRoleset) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GcpSecretRoleset) Namespace() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespace",
...
func (j *jsiiProxy_GcpSecretRoleset) NamespaceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespaceInput",
...
func (j *jsiiProxy_GcpSecretRoleset) Node() constructs.Node {
...
func (j *jsiiProxy_GcpSecretRoleset) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_GcpSecretRoleset) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GcpSecretRoleset) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_GcpSecretRoleset) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_GcpSecretRoleset) Roleset() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleset",
...
func (j *jsiiProxy_GcpSecretRoleset) RolesetInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rolesetInput",
...
func (j *jsiiProxy_GcpSecretRoleset) SecretType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"secretType",
...
func (j *jsiiProxy_GcpSecretRoleset) SecretTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"secretTypeInput",
...
func (j *jsiiProxy_GcpSecretRoleset) ServiceAccountEmail() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceAccountEmail",
...
func (j *jsiiProxy_GcpSecretRoleset) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GcpSecretRoleset) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GcpSecretRoleset) TokenScopes() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"tokenScopes",
...
func (j *jsiiProxy_GcpSecretRoleset) TokenScopesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"tokenScopesInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/resources/gcp_secret_roleset vault_gcp_secret_roleset} Resource.
...
// Experimental.
func GcpSecretRoleset_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGcpSecretRoleset_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func GcpSecretRoleset_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGcpSecretRoleset_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func GcpSecretRoleset_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-vault.gcpSecretRoleset.GcpSecretRoleset",
...
func (g *jsiiProxy_GcpSecretRoleset) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GcpSecretRoleset) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GcpSecretRoleset) MoveFromId(id *string) {
...
func (g *jsiiProxy_GcpSecretRoleset) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GcpSecretRoleset) MoveToId(id *string) {
...
func (g *jsiiProxy_GcpSecretRoleset) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GcpSecretRoleset) ResetNamespace() {
	_jsii_.InvokeVoid(
		g,
		"resetNamespace",
		nil, // no parameters
...
func (g *jsiiProxy_GcpSecretRoleset) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GcpSecretRoleset) ResetSecretType() {
	_jsii_.InvokeVoid(
		g,
		"resetSecretType",
		nil, // no parameters
...
func (g *jsiiProxy_GcpSecretRoleset) ResetTokenScopes() {
	_jsii_.InvokeVoid(
		g,
		"resetTokenScopes",
		nil, // no parameters
...
func (g *jsiiProxy_GcpSecretRoleset) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GcpSecretRoleset) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GcpSecretRoleset) ToHclTerraform() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GcpSecretRoleset) ToMetadata() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GcpSecretRoleset) ToString() *string {
	var returns *string
...
func (g *jsiiProxy_GcpSecretRoleset) ToTerraform() interface{} {
	var returns interface{}
