...
func (s *jsiiProxy_SshSecretBackendRole) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (s *jsiiProxy_SshSecretBackendRole) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (s *jsiiProxy_SshSecretBackendRole) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (s *jsiiProxy_SshSecretBackendRole) validateMoveToParameters(moveTarget *string, index interface{}) error {
	if moveTarget == nil {
		return fmt.Errorf("parameter moveTarget is required, but nil was provided")
	}
...
func (s *jsiiProxy_SshSecretBackendRole) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (s *jsiiProxy_SshSecretBackendRole) validatePutAllowedUserKeyConfigParameters(value interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*SshSecretBackendRoleAllowedUserKeyConfig:
		value := value.(*[]*SshSecretBackendRoleAllowedUserKeyConfig)
	...
	case []*SshSecretBackendRoleAllowedUserKeyConfig:
		value_ := value.([]*SshSecretBackendRoleAllowedUserKeyConfig)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SshSecretBackendRoleAllowedUserKeyConfig; received %#v (a %T)", value, value)
		}
	}
...
func validateSshSecretBackendRole_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
...
func validateSshSecretBackendRole_IsTerraformElementParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func validateSshSecretBackendRole_IsTerraformResourceParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func (j *jsiiProxy_SshSecretBackendRole) validateSetAllowedDomainsTemplateParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_SshSecretBackendRole) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
