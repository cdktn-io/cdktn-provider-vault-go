...
func (j *jsiiProxy_SshSecretBackendRoleAllowedUserKeyConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSshSecretBackendRoleAllowedUserKeyConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SshSecretBackendRoleAllowedUserKeyConfigList {
	_init_.Initialize()
...
func NewSshSecretBackendRoleAllowedUserKeyConfigList_Override(s SshSecretBackendRoleAllowedUserKeyConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SshSecretBackendRoleAllowedUserKeyConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SshSecretBackendRoleAllowedUserKeyConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SshSecretBackendRoleAllowedUserKeyConfigList) Resolve(context cdktn.IResolveContext) interface{} {
