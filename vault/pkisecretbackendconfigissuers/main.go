...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PkiSecretBackendConfigIssuers)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "defaultFollowsLatestIssuer", GoGetter: "DefaultFollowsLatestIssuer"},
			_jsii_.MemberProperty{JsiiProperty: "defaultFollowsLatestIssuerInput", GoGetter: "DefaultFollowsLatestIssuerInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDefaultFollowsLatestIssuer", GoMethod: "ResetDefaultFollowsLatestIssuer"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*PkiSecretBackendConfigIssuersConfig)(nil)).Elem(),
	)
}
