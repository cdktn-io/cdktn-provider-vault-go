...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVaultSshSecretBackendSign)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "criticalOptions", GoGetter: "CriticalOptions"},
			_jsii_.MemberProperty{JsiiProperty: "criticalOptionsInput", GoGetter: "CriticalOptionsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetValidPrincipals", GoMethod: "ResetValidPrincipals"},
			_jsii_.MemberProperty{JsiiProperty: "serialNumber", GoGetter: "SerialNumber"},
			_jsii_.MemberProperty{JsiiProperty: "signedKey", GoGetter: "SignedKey"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVaultSshSecretBackendSignConfig)(nil)).Elem(),
	)
}
