...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVaultRaftAutopilotState)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "failureTolerance", GoGetter: "FailureTolerance"},
			...
			_jsii_.MemberProperty{JsiiProperty: "optimisticFailureTolerance", GoGetter: "OptimisticFailureTolerance"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberProperty{JsiiProperty: "redundancyZones", GoGetter: "RedundancyZones"},
			_jsii_.MemberProperty{JsiiProperty: "redundancyZonesJson", GoGetter: "RedundancyZonesJson"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetNamespace", GoMethod: "ResetNamespace"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "servers", GoGetter: "Servers"},
			_jsii_.MemberProperty{JsiiProperty: "serversJson", GoGetter: "ServersJson"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVaultRaftAutopilotStateConfig)(nil)).Elem(),
	)
}
