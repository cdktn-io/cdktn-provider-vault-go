...
func (l *jsiiProxy_LdapSecretBackendStaticRole) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (l *jsiiProxy_LdapSecretBackendStaticRole) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (l *jsiiProxy_LdapSecretBackendStaticRole) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (l *jsiiProxy_LdapSecretBackendStaticRole) validateMoveToParameters(moveTarget *string, index interface{}) error {
	if moveTarget == nil {
		return fmt.Errorf("parameter moveTarget is required, but nil was provided")
	}
...
func (l *jsiiProxy_LdapSecretBackendStaticRole) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func validateLdapSecretBackendStaticRole_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
...
func (j *jsiiProxy_LdapSecretBackendStaticRole) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
