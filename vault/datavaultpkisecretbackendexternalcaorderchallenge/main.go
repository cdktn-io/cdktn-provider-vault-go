...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVaultPkiSecretBackendExternalCaOrderChallenge)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "keyAuthorization", GoGetter: "KeyAuthorization"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-vault.dataVaultPkiSecretBackendExternalCaOrderChallenge.DataVaultPkiSecretBackendExternalCaOrderChallengeConfig",
		reflect.TypeOf((*DataVaultPkiSecretBackendExternalCaOrderChallengeConfig)(nil)).Elem(),
	)
}
