...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/ldap_auth_backend_group vault_ldap_auth_backend_group}.
...
func (j *jsiiProxy_LdapAuthBackendGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LdapAuthBackendGroup) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_LdapAuthBackendGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LdapAuthBackendGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LdapAuthBackendGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LdapAuthBackendGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/ldap_auth_backend_group vault_ldap_auth_backend_group} Resource.
...
func (j *jsiiProxy_LdapAuthBackendGroup)SetCount(val interface{}) {
...
func (j *jsiiProxy_LdapAuthBackendGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LdapAuthBackendGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LdapAuthBackendGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a LdapAuthBackendGroup resource upon running "cdktn plan <stack-name>".
func LdapAuthBackendGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateLdapAuthBackendGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func LdapAuthBackendGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLdapAuthBackendGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LdapAuthBackendGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLdapAuthBackendGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (l *jsiiProxy_LdapAuthBackendGroup) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LdapAuthBackendGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LdapAuthBackendGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LdapAuthBackendGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LdapAuthBackendGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LdapAuthBackendGroup) MoveFromId(id *string) {
...
func (l *jsiiProxy_LdapAuthBackendGroup) MoveTo(moveTarget *string, index interface{}) {
...
func (l *jsiiProxy_LdapAuthBackendGroup) MoveToId(id *string) {
...
func (l *jsiiProxy_LdapAuthBackendGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LdapAuthBackendGroup) ToHclTerraform() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LdapAuthBackendGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
