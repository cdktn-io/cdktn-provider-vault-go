...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "azureGroups", GoGetter: "AzureGroups"},
			_jsii_.MemberProperty{JsiiProperty: "azureGroupsInput", GoGetter: "AzureGroupsInput"},
			_jsii_.MemberProperty{JsiiProperty: "azureRoles", GoGetter: "AzureRoles"},
			_jsii_.MemberProperty{JsiiProperty: "azureRolesInput", GoGetter: "AzureRolesInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "permanentlyDelete", GoGetter: "PermanentlyDelete"},
			_jsii_.MemberProperty{JsiiProperty: "permanentlyDeleteInput", GoGetter: "PermanentlyDeleteInput"},
			_jsii_.MemberProperty{JsiiProperty: "persistApp", GoGetter: "PersistApp"},
			_jsii_.MemberProperty{JsiiProperty: "persistAppInput", GoGetter: "PersistAppInput"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putAzureGroups", GoMethod: "PutAzureGroups"},
			_jsii_.MemberMethod{JsiiMethod: "putAzureRoles", GoMethod: "PutAzureRoles"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetApplicationObjectId", GoMethod: "ResetApplicationObjectId"},
			_jsii_.MemberMethod{JsiiMethod: "resetAzureGroups", GoMethod: "ResetAzureGroups"},
			_jsii_.MemberMethod{JsiiMethod: "resetAzureRoles", GoMethod: "ResetAzureRoles"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPermanentlyDelete", GoMethod: "ResetPermanentlyDelete"},
			_jsii_.MemberMethod{JsiiMethod: "resetPersistApp", GoMethod: "ResetPersistApp"},
