...
func (j *jsiiProxy_DatabaseSecretsMountMysqlList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDatabaseSecretsMountMysqlList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DatabaseSecretsMountMysqlList {
	_init_.Initialize()

	if err := validateNewDatabaseSecretsMountMysqlListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDatabaseSecretsMountMysqlList_Override(d DatabaseSecretsMountMysqlList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DatabaseSecretsMountMysqlList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DatabaseSecretsMountMysqlList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DatabaseSecretsMountMysqlList) Resolve(context cdktn.IResolveContext) interface{} {
