...
func (j *jsiiProxy_DatabaseSecretsMountRedisElasticacheList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDatabaseSecretsMountRedisElasticacheList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DatabaseSecretsMountRedisElasticacheList {
	_init_.Initialize()
...
func NewDatabaseSecretsMountRedisElasticacheList_Override(d DatabaseSecretsMountRedisElasticacheList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DatabaseSecretsMountRedisElasticacheList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DatabaseSecretsMountRedisElasticacheList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DatabaseSecretsMountRedisElasticacheList) Resolve(context cdktn.IResolveContext) interface{} {
