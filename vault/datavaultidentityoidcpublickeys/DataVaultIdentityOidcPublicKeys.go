...
func (j *jsiiProxy_DataVaultIdentityOidcPublicKeys) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_DataVaultIdentityOidcPublicKeys) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataVaultIdentityOidcPublicKeys) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataVaultIdentityOidcPublicKeys) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataVaultIdentityOidcPublicKeys) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataVaultIdentityOidcPublicKeys) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataVaultIdentityOidcPublicKeys) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataVaultIdentityOidcPublicKeys) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataVaultIdentityOidcPublicKeys) Namespace() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespace",
...
func (j *jsiiProxy_DataVaultIdentityOidcPublicKeys) NamespaceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespaceInput",
...
func (j *jsiiProxy_DataVaultIdentityOidcPublicKeys) Node() constructs.Node {
...
func (j *jsiiProxy_DataVaultIdentityOidcPublicKeys) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_DataVaultIdentityOidcPublicKeys) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataVaultIdentityOidcPublicKeys) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs/data-sources/identity_oidc_public_keys vault_identity_oidc_public_keys} Data Source.
...
// Experimental.
func DataVaultIdentityOidcPublicKeys_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataVaultIdentityOidcPublicKeys_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataVaultIdentityOidcPublicKeys_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataVaultIdentityOidcPublicKeys_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func DataVaultIdentityOidcPublicKeys_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-vault.dataVaultIdentityOidcPublicKeys.DataVaultIdentityOidcPublicKeys",
...
func (d *jsiiProxy_DataVaultIdentityOidcPublicKeys) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataVaultIdentityOidcPublicKeys) ResetNamespace() {
	_jsii_.InvokeVoid(
		d,
		"resetNamespace",
		nil, // no parameters
...
func (d *jsiiProxy_DataVaultIdentityOidcPublicKeys) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataVaultIdentityOidcPublicKeys) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataVaultIdentityOidcPublicKeys) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataVaultIdentityOidcPublicKeys) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataVaultIdentityOidcPublicKeys) ToMetadata() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataVaultIdentityOidcPublicKeys) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataVaultIdentityOidcPublicKeys) ToTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataVaultIdentityOidcPublicKeys) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
