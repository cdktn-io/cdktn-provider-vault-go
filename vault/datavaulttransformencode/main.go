...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "encodedValue", GoGetter: "EncodedValue"},
			_jsii_.MemberProperty{JsiiProperty: "encodedValueInput", GoGetter: "EncodedValueInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEncodedValue", GoMethod: "ResetEncodedValue"},
