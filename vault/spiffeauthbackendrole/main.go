...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SpiffeAuthBackendRole)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetWorkloadIdPatterns", GoMethod: "ResetWorkloadIdPatterns"},
			...
			_jsii_.MemberProperty{JsiiProperty: "workloadIdPatterns", GoGetter: "WorkloadIdPatterns"},
			_jsii_.MemberProperty{JsiiProperty: "workloadIdPatternsInput", GoGetter: "WorkloadIdPatternsInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SpiffeAuthBackendRoleConfig)(nil)).Elem(),
	)
}
