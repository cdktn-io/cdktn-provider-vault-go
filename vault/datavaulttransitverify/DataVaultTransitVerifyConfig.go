...
type DataVaultTransitVerifyConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_verify#name DataVaultTransitVerify#name}
	Name *string `field:"required" json:"name" yaml:"name"`
	// The Transit secret backend the key belongs to.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_verify#path DataVaultTransitVerify#path}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_verify#batch_results DataVaultTransitVerify#batch_results}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_verify#context DataVaultTransitVerify#context}
	Context *string `field:"optional" json:"context" yaml:"context"`
	// Specifies the hash algorithm to use.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_verify#hash_algorithm DataVaultTransitVerify#hash_algorithm}
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_verify#id DataVaultTransitVerify#id}.
	//
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_verify#input DataVaultTransitVerify#input}
	Input *string `field:"optional" json:"input" yaml:"input"`
	// Specifies the MAC length used to generate a CMAC. The mac_length cannot be larger than the cipher's block size.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_verify#mac_length DataVaultTransitVerify#mac_length}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_verify#marshaling_algorithm DataVaultTransitVerify#marshaling_algorithm}
	MarshalingAlgorithm *string `field:"optional" json:"marshalingAlgorithm" yaml:"marshalingAlgorithm"`
	// Target namespace. (requires Enterprise).
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_verify#namespace DataVaultTransitVerify#namespace}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_verify#salt_length DataVaultTransitVerify#salt_length}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_verify#signature_algorithm DataVaultTransitVerify#signature_algorithm}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_verify#signature_context DataVaultTransitVerify#signature_context}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs/data-sources/transit_verify#valid DataVaultTransitVerify#valid}
