...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVaultLdapStaticCredentials)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "lastPassword", GoGetter: "LastPassword"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVaultLdapStaticCredentialsConfig)(nil)).Elem(),
	)
}
