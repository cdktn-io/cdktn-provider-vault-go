...
type VaultProviderAuthLoginJwt struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.1/docs#distributed_claim_access_token VaultProvider#distributed_claim_access_token}
