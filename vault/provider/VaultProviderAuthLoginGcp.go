...
type VaultProviderAuthLoginGcp struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs#credentials VaultProvider#credentials}
	...
	// IAM service account.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs#service_account VaultProvider#service_account}
