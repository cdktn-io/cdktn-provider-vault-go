...
type VaultProviderAuthLoginAzure struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs#resource_group_name VaultProvider#resource_group_name}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs#subscription_id VaultProvider#subscription_id}
	SubscriptionId *string `field:"required" json:"subscriptionId" yaml:"subscriptionId"`
	// The identity's client ID.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs#client_id VaultProvider#client_id}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs#scope VaultProvider#scope}
	Scope *string `field:"optional" json:"scope" yaml:"scope"`
	// Provides the tenant ID to use in a multi-tenant authentication scenario.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.9.0/docs#tenant_id VaultProvider#tenant_id}
