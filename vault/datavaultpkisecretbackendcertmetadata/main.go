...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVaultPkiSecretBackendCertMetadata)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "serialInput", GoGetter: "SerialInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVaultPkiSecretBackendCertMetadataConfig)(nil)).Elem(),
	)
}
