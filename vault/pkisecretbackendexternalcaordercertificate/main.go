...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PkiSecretBackendExternalCaOrderCertificate)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-vault.pkiSecretBackendExternalCaOrderCertificate.PkiSecretBackendExternalCaOrderCertificateConfig",
		reflect.TypeOf((*PkiSecretBackendExternalCaOrderCertificateConfig)(nil)).Elem(),
	)
}
