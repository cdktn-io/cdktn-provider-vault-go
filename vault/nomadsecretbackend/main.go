...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "maxTokenNameLength", GoGetter: "MaxTokenNameLength"},
			_jsii_.MemberProperty{JsiiProperty: "maxTokenNameLengthInput", GoGetter: "MaxTokenNameLengthInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMaxTokenNameLength", GoMethod: "ResetMaxTokenNameLength"},
