...
import (
	...
	"github.com/cdktn-io/cdktn-provider-vault-go/vault/v17/rgppolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/rgp_policy vault_rgp_policy}.
...
func (j *jsiiProxy_RgpPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RgpPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RgpPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RgpPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RgpPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.10.0/docs/resources/rgp_policy vault_rgp_policy} Resource.
...
func (j *jsiiProxy_RgpPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RgpPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RgpPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a RgpPolicy resource upon running "cdktn plan <stack-name>".
func RgpPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RgpPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RgpPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RgpPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RgpPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
