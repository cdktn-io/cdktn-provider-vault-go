...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LdapSecretBackendLibrarySet)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "disableCheckInEnforcement", GoGetter: "DisableCheckInEnforcement"},
			_jsii_.MemberProperty{JsiiProperty: "disableCheckInEnforcementInput", GoGetter: "DisableCheckInEnforcementInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDisableCheckInEnforcement", GoMethod: "ResetDisableCheckInEnforcement"},
			...
			_jsii_.MemberProperty{JsiiProperty: "serviceAccountNames", GoGetter: "ServiceAccountNames"},
			_jsii_.MemberProperty{JsiiProperty: "serviceAccountNamesInput", GoGetter: "ServiceAccountNamesInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LdapSecretBackendLibrarySetConfig)(nil)).Elem(),
	)
}
