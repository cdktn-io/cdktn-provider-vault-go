...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PkiSecretBackendAcmeEab)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "acmeDirectory", GoGetter: "AcmeDirectory"},
			...
			_jsii_.MemberProperty{JsiiProperty: "eabId", GoGetter: "EabId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*PkiSecretBackendAcmeEabConfig)(nil)).Elem(),
	)
}
