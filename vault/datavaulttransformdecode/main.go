...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVaultTransformDecode)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "decodedValue", GoGetter: "DecodedValue"},
			_jsii_.MemberProperty{JsiiProperty: "decodedValueInput", GoGetter: "DecodedValueInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDecodedValue", GoMethod: "ResetDecodedValue"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetNamespace", GoMethod: "ResetNamespace"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetTransformation", GoMethod: "ResetTransformation"},
			_jsii_.MemberMethod{JsiiMethod: "resetTweak", GoMethod: "ResetTweak"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tweak", GoGetter: "Tweak"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVaultTransformDecodeConfig)(nil)).Elem(),
	)
}
