...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVaultLdapDynamicCredentials)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "distinguishedNames", GoGetter: "DistinguishedNames"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVaultLdapDynamicCredentialsConfig)(nil)).Elem(),
	)
}
