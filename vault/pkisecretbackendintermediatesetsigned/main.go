...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PkiSecretBackendIntermediateSetSigned)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "importedIssuers", GoGetter: "ImportedIssuers"},
			_jsii_.MemberProperty{JsiiProperty: "importedKeys", GoGetter: "ImportedKeys"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*PkiSecretBackendIntermediateSetSignedConfig)(nil)).Elem(),
	)
}
