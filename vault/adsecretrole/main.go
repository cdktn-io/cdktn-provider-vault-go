...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AdSecretRole)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "passwordLastSet", GoGetter: "PasswordLastSet"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AdSecretRoleConfig)(nil)).Elem(),
	)
}
