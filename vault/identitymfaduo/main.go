...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IdentityMfaDuo)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "pushInfo", GoGetter: "PushInfo"},
			_jsii_.MemberProperty{JsiiProperty: "pushInfoInput", GoGetter: "PushInfoInput"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetNamespace", GoMethod: "ResetNamespace"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetPushInfo", GoMethod: "ResetPushInfo"},
			_jsii_.MemberMethod{JsiiMethod: "resetUsePasscode", GoMethod: "ResetUsePasscode"},
			...
			_jsii_.MemberProperty{JsiiProperty: "usePasscode", GoGetter: "UsePasscode"},
			_jsii_.MemberProperty{JsiiProperty: "usePasscodeInput", GoGetter: "UsePasscodeInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*IdentityMfaDuoConfig)(nil)).Elem(),
	)
}
