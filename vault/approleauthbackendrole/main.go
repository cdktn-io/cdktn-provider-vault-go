...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "bindSecretId", GoGetter: "BindSecretId"},
			_jsii_.MemberProperty{JsiiProperty: "bindSecretIdInput", GoGetter: "BindSecretIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSecretIdBoundCidrs", GoMethod: "ResetSecretIdBoundCidrs"},
			_jsii_.MemberMethod{JsiiMethod: "resetSecretIdNumUses", GoMethod: "ResetSecretIdNumUses"},
			_jsii_.MemberMethod{JsiiMethod: "resetSecretIdTtl", GoMethod: "ResetSecretIdTtl"},
			...
			_jsii_.MemberProperty{JsiiProperty: "secretIdBoundCidrs", GoGetter: "SecretIdBoundCidrs"},
			_jsii_.MemberProperty{JsiiProperty: "secretIdBoundCidrsInput", GoGetter: "SecretIdBoundCidrsInput"},
			_jsii_.MemberProperty{JsiiProperty: "secretIdNumUses", GoGetter: "SecretIdNumUses"},
			_jsii_.MemberProperty{JsiiProperty: "secretIdNumUsesInput", GoGetter: "SecretIdNumUsesInput"},
			_jsii_.MemberProperty{JsiiProperty: "secretIdTtl", GoGetter: "SecretIdTtl"},
			_jsii_.MemberProperty{JsiiProperty: "secretIdTtlInput", GoGetter: "SecretIdTtlInput"},
