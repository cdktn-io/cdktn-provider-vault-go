...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVaultPkiExternalCaSecretBackendOrderChallenge)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVaultPkiExternalCaSecretBackendOrderChallengeConfig)(nil)).Elem(),
	)
}
